...
class MyClient():                                                                    # my client class
    ...
    def newframe(self):                                                              # creates GUI
        ...
        self.but_ton = Button(fr1, text='Send', command=self.printtext)               # button to send,commit,abort log in and to quit
    ...
    def username(self, msg, r):                                         #functiom to get the username from the first message the client sends
        ...
        if len(r) == 1:
            c = (r[0]) + '.txt'
            print(r[0])
            text_files = [f for f in os.listdir('F:\spring2018\Distributed System\server client') if f.endswith('.txt')]
    ...
    def receivemsg(self):                                               # to receive message
        ...
        while True:
            ...
            if 'entered room' in msg:                                   # to get the username
                ...
                Timer(25, self.timmer, ()).start()                      #timmer to check if the coodinator has responded or not
